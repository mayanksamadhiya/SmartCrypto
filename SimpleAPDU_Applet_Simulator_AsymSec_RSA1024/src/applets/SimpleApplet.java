...
//----------------------------------------------------PROCESS----------------------------------------------------
    ...
    void AsymSec_PC_Card_1(APDU apdu) {
        ...
        byte[] cardPubKeyMod129 = null;
        byte[] cardPubKeyExp = null;
        short cardPubKeyModSize = 129;
        ...
        try {
            ...
            cardPubKeyMod129 = JCSystem.makeTransientByteArray(cardPubKeyModSize, JCSystem.CLEAR_ON_DESELECT);
            ((RSAPublicKey) cardPub).getModulus(cardPubKeyMod129, (short) 0);
        ...
        Util.arrayCopyNonAtomic(cardPubKeyMod129, (short) 0, m_ramArray, (short) 0, (short) (cardPubKeyMod129.length));
        Util.arrayCopyNonAtomic(cardPubKeyExp, (short) 0, m_ramArray, (short) (cardPubKeyMod129.length), (short) cardPubKeyExp.length);
        Util.arrayCopyNonAtomic(m_counter, (short) 0, m_ramArray, (short) ((cardPubKeyMod129.length) + cardPubKeyExp.length), (short) m_counter.length);

        m_encryptCipherCBC.doFinal(m_ramArray, (short) 0, (short) (m_counter.length + (cardPubKeyMod129.length) + cardPubKeyExp.length + 8), apdubuf, ISO7816.OFFSET_CDATA);
        ...
        apdu.setOutgoingAndSend(ISO7816.OFFSET_CDATA, (short) (m_counter.length + (cardPubKeyMod129.length) + cardPubKeyExp.length + 8));
    }
    ...
    void AsymSec_PC_Card_2(APDU apdu) {
        ...
        byte[] pcPubKeyMod129 = JCSystem.makeTransientByteArray((short)(pcPubKeyModSize+1), JCSystem.CLEAR_ON_DESELECT);
        Util.arrayCopy(pcPubKey, (short) 0, pcPubKeyMod129, (short) 1, (short) pcPubKeyMod.length);
        pcPubKeyMod129[0] = 0x00;
        ...
        try {
            ...
            ((RSAPublicKey) pcPub).setModulus(pcPubKeyMod129, (short) 0, pcPubKeyMod129Size);
            //cardPubKeyExp = JCSystem.makeTransientByteArray(cardPubKeyExpSize, JCSystem.CLEAR_ON_DESELECT);
