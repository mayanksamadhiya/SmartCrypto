...
public class FileJInternalFrame extends javax.swing.JInternalFrame  implements UpdatingProgress
{
    ...
    private void jb_encryptActionPerformed(java.awt.event.ActionEvent evt) {                                           
        // TODO add your handling code here:
    ...
    private void jb_decryptActionPerformed(java.awt.event.ActionEvent evt) {                                           
        // TODO add your handling code here:
    ...
    private void jb_deleteFileActionPerformed(java.awt.event.ActionEvent evt) {                                              
        // TODO add your handling code here:
        if( (a_actionThread==null) || a_actionThread.M_getHasEnded() )
        {
            //Custom button text
    ...
    private void jb_clearHistoryActionPerformed(java.awt.event.ActionEvent evt) {                                                
        // TODO add your handling code here:

        M_clearHistory();
    }                                               

    private void jb_encryptingConfigurationActionPerformed(java.awt.event.ActionEvent evt) {                                                           
        // TODO add your handling code here:
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {                                         
        ...
        String passwordFromCard = null;
        String strArray[] = {"Test1", "Test2"};
        long startTime = System.currentTimeMillis();
        try {
            passwordFromCard = SimpleAPDU.main(strArray);
        ...
        if(passwordFromCard != null && passwordFromCard!="") {
            jPasswordField1.setText(passwordFromCard);
            jPasswordField2.setText(passwordFromCard);
            passwordSet = true;
        }
        ...
        if( (a_actionThread==null) || a_actionThread.M_getHasEnded() )
        {
            if( M_arePasswordsEqual() && (passwordSet == true))
            {
                a_actionThread = new DecryptFileThread( this,
                    jtf_fileName.getText(),
                    jPasswordField1.getPassword(),
        ...
        File timeFile = new File("timeDec.txt");
                try {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {                                         
        ...
        long endTime = System.currentTimeMillis();
        //JOptionPane.showMessageDialog(null, passwordFromCard);
        
        File passwordFile = new File("password.txt");
                try {
                    BufferedWriter br = new BufferedWriter(new FileWriter(passwordFile));
                    br.write(passwordFromCard);
                    br.close();
                } catch (FileNotFoundException e) {
                    e.printStackTrace();
                } catch (IOException e) {
        ...
        if( (a_actionThread==null) || a_actionThread.M_getHasEnded() )
        {
            //JOptionPane.showMessageDialog(null, passwordSet);
            if(M_arePasswordsEqual() && (passwordSet == true))
            {
                a_actionThread = new EncryptFileThread( this,
                    jtf_fileName.getText(),
        ...
        long totalTime = endTime - startTime;
        File timeFile = new File("timeEnc.txt");
                try {
                    BufferedWriter br = new BufferedWriter(new FileWriter(timeFile));
                    br.write(totalTime + "\n");
                    br.close();
